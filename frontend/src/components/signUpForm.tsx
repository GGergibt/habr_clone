...
import PopupPassword from './popupConfirmPasswordsError' 
...
export const SignUpForm = () => {
	...
	const [isPasswordsCompares, setIsPasswordsCompares] = useState(true)
	...
	const errorHandling = (errorResponse: any) => {
